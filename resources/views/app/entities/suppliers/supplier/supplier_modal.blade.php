<x-modal modalId="modalSupplier" formId="formSupplier" :input="$input">
    <div class="row">
    ...
    <div class="row mx-1">
        <x-check-input col="6" id="is_active" name="is_active" type="checkbox" label="Fornecedor ativo?" check=""></x-check-input>
    </div>
</x-modal>

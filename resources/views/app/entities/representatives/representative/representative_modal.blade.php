<x-modal modalId="modalRepresentative" formId="formRepresentative" :input="$input">
    <div class="row">
    ...
    <div class="row mx-1">
        <x-check-input col="6" id="is_active" name="is_active" type="checkbox" label="Representante ativo?" check=""></x-check-input>
    </div>
</x-modal>

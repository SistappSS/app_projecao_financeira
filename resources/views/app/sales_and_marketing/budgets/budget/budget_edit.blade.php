                ...
                <div class="col-12">
                    <div class="card p-0">
                        ...
                        <div class="card-header">
                            ...
                            <div class="row">
                                <x-select col="4" set="" id="customer_id" name="customer_id" label="Cliente">
            ...
            $.ajax({
                ...
                success: function (response) {
                    if (Array.isArray(response.data)) {
                        let options = response.data.map(client => `<option value="${client.id}">${client.name}</option>`).join('');

                    ...
                    <div class="card-body">
                        ...
                        <div class="scroll dashboard-list-with-user">
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{asset('assets/img/profiles/l-1.jpg')}}" alt="Mayra Sibley"
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{asset('assets/img/profiles/l-7.jpg')}}" alt="Mimi Carreira"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{asset('assets/img/profiles/l-6.jpg')}}" alt="Philip Nelms"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{asset('assets/img/profiles/l-3.jpg')}}" alt="Terese Threadgill"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{asset('assets/img/profiles/l-5.jpg')}}" alt="Kathryn Mengel"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="d-flex flex-row mb-3 pb-3 border-bottom">
                                <a href="#">
                                    <img src="{{asset('assets/img/profiles/l-4.jpg')}}" alt="Esperanza Lodge"
                                         class="img-thumbnail border-0 rounded-circle list-thumbnail align-self-center xsmall" />
                                </a>
                                <div class="pl-3">
                                    <a href="#">
                            ...
                            <div class="glide__track" data-glide-el="track">
                                <div class="glide__slides">
                                    <div class="glide__slide">
                                        <img src="{{asset('assets/img/carousels/1.jpg')}}" alt="Cheesecake" class="mb-4">
                                    ...
                                    <div class="glide__slide">
                                        <img src="{{asset('assets/img/carousels/2.jpg')}}" alt="Chocolate Cake" class="mb-4">
                                    ...
                                    <div class="glide__slide">
                                        <img src="{{asset('assets/img/carousels/3.jpg')}}" alt="Cremeschnitte" class="mb-4">

...
const options = {
    route: route,
    inputId: "representative_id",
    modalId: "#modalRepresentative",
    formId: "#formRepresentative",
    tableId: "#tableRepresentative",
    createbtn: ".createbtn",
    viewbtn: ".viewbtn",
    editbtn: ".editbtn",
    deletebtn: ".deletebtn",
    createTitle: "de representante",
    viewTitle: "Visualizar representante",
